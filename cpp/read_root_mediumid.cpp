...
int main() {
    ...
    writeRootFile(mcTreeHigh, "../data/processed/signal/mcDYhigh_id.root", wsum, true, true);
    cout << "Wsum for mcTreeHigh: " << wsum << endl;

    writeRootFile(mcTreeLow, "../data/processed/signal/mcDYlow_id.root", wsum, true, true);
    cout << "Wsum for mcTreeLow: " << wsum << endl;

    writeRootFile(ttbarTree, "../data/processed/background/ttbar_id.root", wsum, true, false);
    cout << "Wsum for top-antitop (ttbar): " << wsum << endl;

    writeRootFile(twTree, "../data/processed/background/tW_id.root", wsum, true, false);
    cout << "Wsum for tW: " << wsum << endl;

    writeRootFile(awTree, "../data/processed/background/antitopW_id.root", wsum, true, false);
    cout << "Wsum for antitop W (aw): " << wsum << endl;

    writeRootFile(stTree, "../data/processed/background/singletop_id.root", wsum, true, false);
    cout << "Wsum for single top (t-channel) (st): " << wsum << endl;

    writeRootFile(saTree, "../data/processed/background/sa_id.root", wsum, true, false);
    cout << "Wsum for single antitop (t-channel) (sa): " << wsum << endl;

    writeRootFile(zzTree, "../data/processed/background/zz_id.root", wsum, true, false);
    cout << "Wsum for ZZ: " << wsum << endl;

    writeRootFile(wzTree, "../data/processed/background/wz_id.root", wsum, true, false);
    cout << "Wsum for WZ: " << wsum << endl;

    writeRootFile(wwTree, "../data/processed/background/ww_id.root", wsum, true, false);
