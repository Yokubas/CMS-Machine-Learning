...
void writeRootFile(TTree* tree, const char* outFileName, double& sumGenWeight, bool isMC, bool isDY, bool isWJets){
    ...
    tree->SetBranchStatus("Photon_pt", true);
    tree->SetBranchStatus("Photon_eta", true);
    tree->SetBranchStatus("Photon_phi", true);
    tree->SetBranchStatus("Photon_sieie", true);
    tree->SetBranchStatus("Photon_hoe", true);
    tree->SetBranchStatus("Photon_pfRelIso03_all", true);
    tree->SetBranchStatus("nPhoton", true);
    ...
    Float_t Photon_pt[100], Photon_eta[100], Photon_phi[100], Photon_sieie[100], Photon_hoe[100], Photon_pfRelIso03_all[100];
    UInt_t nPhoton;
    sumGenWeight = 0.0;
    ...
    Float_t out_Photon_pt[2], out_Photon_eta[2], out_Photon_phi[2], out_Photon_sieie[2], out_Photon_hoe[2], out_Photon_pfRelIso03_all[2];
    ...
    tree->SetBranchAddress("Photon_pfRelIso03_all", &Photon_pfRelIso03_all);
    ...
    if (isDY) {
        ...
        outTree_tau->Branch("Photon_pt", out_Photon_pt, "Photon_pt[2]/F");
        outTree_tau->Branch("Photon_eta", out_Photon_eta, "Photon_eta[2]/F");
        outTree_tau->Branch("Photon_phi", out_Photon_phi, "Photon_phi[2]/F");
        outTree_tau->Branch("Photon_sieie", out_Photon_sieie, "Photon_sieie[2]/F");
        outTree_tau->Branch("Photon_hoe", out_Photon_hoe, "Photon_hoe[2]/F");
        outTree_tau->Branch("Photon_pfRelIso03_all", out_Photon_pfRelIso03_all, "Photon_pfRelIso03_all[2]/F");
    }
    ...
    outTree->Branch("Photon_pt", out_Photon_pt, "Photon_pt[2]/F");
    outTree->Branch("Photon_eta", out_Photon_eta, "Photon_eta[2]/F");
    outTree->Branch("Photon_phi", out_Photon_phi, "Photon_phi[2]/F");
    outTree->Branch("Photon_sieie", out_Photon_sieie, "Photon_sieie[2]/F");
    outTree->Branch("Photon_hoe", out_Photon_hoe, "Photon_hoe[2]/F");
    outTree->Branch("Photon_pfRelIso03_all", out_Photon_pfRelIso03_all, "Photon_pfRelIso03_all[2]/F");
        ...
        if (isWJets) {
            ...
            if (Electron_pt[idx1] > 28 && Electron_pt[idx2] > 20 && 
                    ...
                    !(fabs(Electron_eta[idx2]) > 1.4442 && fabs(Electron_eta[idx2]) < 1.566)) {
                        ...
                        for (UInt_t p = 0; p < nPhoton; p++) {

                            float dr1 = deltaR(Electron_eta[idx1], Electron_phi[idx1],
                                                Photon_eta[p], Photon_phi[p]);
                            ...
                            float dr2 = deltaR(Electron_eta[idx2], Electron_phi[idx2],
                                                Photon_eta[p], Photon_phi[p]);
                        ...
                        if (bestPho1 >= 0) {
                            out_Photon_pt[0]  = Photon_pt[bestPho1];
                            out_Photon_eta[0] = Photon_eta[bestPho1];
                            out_Photon_phi[0] = Photon_phi[bestPho1];
                            out_Photon_sieie[0] = Photon_sieie[bestPho1];
                            out_Photon_hoe[0] = Photon_hoe[bestPho1]; 
                            out_Photon_pfRelIso03_all[0] = Photon_pfRelIso03_all[bestPho1];
                        }

                        if (bestPho2 >= 0) {
                            out_Photon_pt[1]  = Photon_pt[bestPho2];
                            out_Photon_eta[1] = Photon_eta[bestPho2];
                            out_Photon_phi[1] = Photon_phi[bestPho2];
                            out_Photon_sieie[1] = Photon_sieie[bestPho2];
                            out_Photon_hoe[1] = Photon_hoe[bestPho2]; 
                            out_Photon_pfRelIso03_all[1] = Photon_pfRelIso03_all[bestPho2];
                        }
                        outTree->Fill(); 
                    }
